...
<html lang="zxx">
  ...
  <body>
    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
          ...
          <div class="row headder-contact">
            ...
            <div class="col-lg-6 col-md-5 col-sm-3 icons px-0">
              <ul>
                ...
                <a href="<?php echo base_url('index.php/Indexcontroller/index')?>"><img src="<?php echo base_url('Asset/Vendor/images/home.png')?>" style="height: 50px;width: 50px"></a>
              </ul>
            </div>
          </div>
        </div>
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="hedder-up">
            <h1 ><a href="<?php echo base_url('index.php/Vendorcontroller/vendor_index')?>" class="navbar-brand" data-blast="color">Rent Management System</a></h1>
          </div>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul class="navbar-nav ">
               ...
               <!--  <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="#stats" class="nav-link scroll">Signup</a>
                </li>
               <!--  <li class="nav-item">
                  <a href="#contact" class="nav-link scroll">Signup</a>
                </li> -->
                <li class="nav-item">
                  <a href="#blog" class="nav-link scroll">Login</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <!--//service-->
    <!--blog -->
    <section class="" id="blog" style="background-color: grey">
     <section class="" id="contact">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Login Now</h3>
        <div class="row">
   ...
   <!--  <section class="py-md-5 py-sm-4 py-3">
    ...
    <!--//Subscribe-->
    <!--stats-->
    <section  id="stats" style="background-color: grey">
       <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Register Here</h3>
        <div class="row">
         
          <div class="col-md-9 contact-form">
            <form action="<?php echo base_url('index.php/Vendorcontroller/vendor_reginsrt')?>" method="post">
               <div class="form-group contact-forms">
              ...
              <div class="form-group contact-forms">
               ...
               <div class="form-group contact-forms">
                <input type="text" class="form-control" placeholder="OCCUPATION" required="" name="Occupation">
              </div>

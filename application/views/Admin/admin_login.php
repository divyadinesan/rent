...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
		<form action="<?php echo base_url('index.php/Admincontroller/login_insrt'); ?>" method="POST">
		...
		<p><a href="<?php echo base_url('index.php/Indexcontroller/index'); ?>"><i style="font-size: 73px;" class="fa fa-home"></i></a></p>
</div>
</div>

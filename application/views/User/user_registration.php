...
<div class="contact-w3ls" id="">
     ...
     <div class="container" align="center">
         <div class="col-md-8 price" align="center" style="margin-top: -30px;margin-left: 150px">
				<h3><span class="one">R</span>egister <span class="one">  H</span>ere</h3>
					<form action="<?php echo base_url('index.php/Usercontroller/user_reg_insrt')?>" method="post">
		...
		<h4>Already Registered..<a href="<?php echo base_url('index.php/Usercontroller/user_login')?>">Login Now..!</a></h4><br>
		 <center>

     ...
     <div class="container" align="center">
         <div class="col-md-8 price" align="center" style="margin:150px">
				<h3><span class="one">E</span>nter Your<span class="one">R</span>eview  </h3>
					  <form method="post" action="<?php echo base_url('index.php/Usercontroller/house_review')?>" style="margin:80px">
				...
				<div class="reservation" align="center">
					...
					<div class="col-md-4 col-sm-4 news-img" align="center">
                                    ...
                                    <img src="<?php echo base_url('Asset/Vendor/house/'.$hse->h_image)?>" alt="" class="image-fluid" style="height: 200px;width: 400px" ><br><br><br><br>
                                    <p class="mt-3"> 
                                    </div>
                        ...
                        <input type="hidden" name="user_mail" value="<?php echo $usr->user_email?>" placeholder="email">
                        <input type="hidden" name="house_id" value="<?php echo  $hse->house_id?>">
                        <input type="text" name="Address" value="<?php echo $hse->h_Address?>" style="background-color: black;color: white;height: 50px;width:600px"><br><br>
                        ...
                        <select name="h_rating" style="background-color: black;height: 50px;width:600px">
                           <option value="☆☆☆☆☆">🌟🌟🌟🌟🌟</option>
                           <option value="☆☆☆☆">🌟🌟🌟🌟✩</option>
                           <option value="☆☆☆">🌟🌟🌟✩✩</option>
                           <option value="☆☆">🌟🌟✩✩✩</option>
